...
execSync(
  `npx tsc lib/substyles.ts lib/stages.ts lib/creativeOptions.ts lib/devices.ts ` +
...
console.log(
  `standalone/beatsmith.html written (${(html.length / 1024).toFixed(0)} KB) — ` +
    `${data.CREATIVE_OPTIONS.length} options, ${data.SUBSTYLES.length} substyles, ${data.STAGES.length} stages`
);
